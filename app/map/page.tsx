    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      <div className="flex-1 relative">
        <div className="h-[calc(100vh-180px)] sm:h-[calc(100vh-200px)] relative">
          ...
          <div className="absolute top-2 left-2 md:top-4 md:left-4 bg-white dark:bg-gray-800 rounded-lg shadow-lg p-3 md:p-4 w-[calc(100vw-1rem)] sm:w-80 md:max-w-sm max-h-[55vh] md:max-h-96 overflow-y-auto overscroll-contain z-10 scrollbar-thin scrollbar-thumb-gray-300 dark:scrollbar-thumb-gray-600 scrollbar-track-transparent">
            <h4 className="font-semibold text-gray-900 dark:text-white mb-2 md:mb-3 flex items-center gap-2 text-sm md:text-base">
